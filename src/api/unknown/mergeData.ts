...
export default function mergeData(dateHeaders: any, jhuData: any, dxyDate: any) {
  ...
  return jhuData.map((point: any) => {
    ...
    const relevantData = dxyDate.find((s: any) => s.provincestate === point.provincestate)
