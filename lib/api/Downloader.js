...
const china_1 = __importDefault(require("./unknown/china"));
...
class Downloader {
    ...
    async fetchData() {
        ...
        const [conf_req, rec_req, dea_req, china_req] = await Promise.all([
            ...
            axios_1.default.get(`https://ncov.dxy.cn/ncovh5/view/pneumonia`)
        ]);
        ...
        const china_raw = china_1.default(china_req.data);
        // @ts-ignore
        ...
        const fulldata = confirmed.map(d => {
            ...
            return Object.assign(Object.assign(Object.assign({ 
                ...
                lat: d["Lat"], 
                // @ts-ignore
                long: d['Long'], headers: dateHeaders.join(";;") }, extraConfirmed), extraRecovered), extraDeath);
        });
